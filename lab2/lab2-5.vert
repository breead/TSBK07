...
void main(void)
{
	mat3 normalMatrix1 = mat3(mdlMatrix*rotationMatrix * rotationMatrix2);
	gl_Position = projectionMatrix * wrlMatrix* mdlMatrix *rotationMatrix * rotationMatrix2 * vec4(in_Position, 1.0);
